...
return [
    ...
    */
    ...
    'contains' => 'Поле :attribute содержит отсутствующее обязательное значение.',
    ...
    'doesnt_contain' => 'Поле :attribute не должно содержать одно из следующих значений: :values.',
